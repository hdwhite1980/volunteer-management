                      ...
                      <div key={index} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                        <div className="flex justify-between items-start mb-3">
                          <div className="flex-1 min-w-0">
                            <h3 className="font-semibold text-gray-900 text-sm mb-1">{log.name}</h3>
                            <p className="text-xs text-gray-600 break-all">{log.email}</p>
                          </div>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-xs text-gray-900 font-medium">{log.organization}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-xs text-gray-500">Total Hours</span>
                            <span className="text-xs text-gray-900 font-semibold">{Math.round(log.total_hours || 0)}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-xs text-gray-500">Date</span>
                            <span className="text-xs text-gray-900">{new Date(log.created_at).toLocaleDateString()}</span>
                          </div>
                        </div>
                      </div>
                    ))}
