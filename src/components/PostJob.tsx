// src/components/PostJob.tsx - Updated with Hierarchical Categories
import React, { useState } from 'react';
import { Plus, MapPin, Users, Clock, AlertCircle, CheckCircle, ArrowRight, ArrowLeft, Calendar, Shield } from 'lucide-react';
import { VOLUNTEER_CATEGORIES, getSubcategories, getCategoryDisplayLabel } from '@/lib/categories';
...
const PostJob = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Prepare category string for database
      const categoryForDB = formData.subcategory 
      ...
      // Remove subcategory from submit data since it's combined with category
            ...
            {currentStep === 1 && (
              <div>
                ...
                <div className="space-y-4">
                  ...
                  {/* Subcategory dropdown - only show when main category is selected */}
                  {formData.category && availableSubcategories.length > 0 && (
                    <div>
                      ...
                      <select
                        ...
                        className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      >
                        <option value="">General {getCategoryDisplayLabel(formData.category)}</option>
